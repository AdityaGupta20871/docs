...
1. Click "New Variable" under **Additional Configuration** to add a new environment variable.
...
Region refers to specific geographic locations here a cloud service provider (CSP) has its data centers and computing resources.
...
1. Click "Advanced Configuration" under **Additional Configuration** if you want to add advanced configuration.
