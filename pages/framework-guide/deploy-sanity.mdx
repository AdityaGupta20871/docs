...
# How to Deploy Sanity Apps on Spheron
...
You can create a new Spheron project using the platform UI. First, visit [Spheron Network](https://app.spheron.network/) in your browser.
...
<Callout>
  **Troubleshoot:** \ For your deployments to work correctly, you need to add
  `@sanity/cli` as a dev dependency by running this command in your terminal:
  `npm i -D @sanity/cli`
</Callout>

We're so excited to see what you build with Sanity on Spheron!

<Navigation name="Deploy Sanity App" />
