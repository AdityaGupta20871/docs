...
Follow the instructions in the [DOCS](https:// docs.spheron.network/rest-api/#creating-an-access-token) to generate this token. When you are creating the tokens, please choose **Compute** type in
  the dashboard.
